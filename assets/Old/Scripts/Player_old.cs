...
public class Player_old : MonoBehaviour{
    ...
    public Bullet_old bulletPrefab;
    ...
    private void Shoot(){
        Bullet_old bullet = Instantiate(this.bulletPrefab, this.transform.position, this.transform.rotation);
    ...
    private void OnCollisionEnter2D(Collision2D collision){
        ...
        if (collision.gameObject.tag == "Asteroid"){
            ...
            FindObjectOfType<GameManager_old>().PlayerDied();
        }
